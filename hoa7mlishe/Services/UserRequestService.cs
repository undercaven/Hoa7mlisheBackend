...
namespace hoa7mlishe.API.Services
{
    internal class UserRequestService : IUserRequestService
    {
        ...
        public User GetUser(IIdentity identity)
        {
            ...
            var claim = claims.FindFirst("http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier");
        ...
        public TokenApiDTO UpdateRefreshToken(TokenApiDTO tokenInfo)
        {
            ...
            var userID = Guid.Parse(tokenPrincipals.FindFirst("http://schemas.xmlsoap.org/ws/2005/05/identity/claims/nameidentifier")?.Value);
